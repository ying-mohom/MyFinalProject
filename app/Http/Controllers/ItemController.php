...
class ItemController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if ($item) {
            ...
            return redirect()->back()->with("error", "Something Wrong or Item does not exist!");
        }
    }
    ...
    public function update(NormalRegisterRequest $request)
    {
        ...
        //Show Error Message
        if (!$updateItem) {
            return redirect(Session::get('requestReferrer'))->with('error', 'Something Wrong or Item does not exist!');
        }
    ...
    public function destroy(Request $request)
    {
        ...
        if ($deleteItem) {
            ...
            session()->flash('error', "Something Wrong or Item does not exist!");
            return response()->json([
                'success' => false,
